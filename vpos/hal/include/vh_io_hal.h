...
#define vh_VIC0INTSELECT	(*(volatile unsigned *) (vh_VIC0_BASE + 0xc))
#define vh_VIC0INTENABLE	(*(volatile unsigned *) (vh_VIC0_BASE + 0x10))
#define vh_VIC0INTENCLEAR	(*(volatile unsigned *) (vh_VIC0_BASE + 0x14))
#define vh_VIC0SWPRIORITYMASK	(*(volatile unsigned *) (vh_VIC0_BASE + 0x24))
#define vh_VIC0VECTADDR25	(*(volatile unsigned *) (vh_VIC0_BASE + 0x164))
...
#define vh_GPJ2DAT	(*(volatile unsigned *) 0xe300244)
...
#define vh_UART_CTL_BASE 		0xec000000 // UART 1 register bease address
